...
import { GcpFunction } from './gcpFunction';
// import {workload_identity_provider} from "./workloadIdentityPools";
...
// const tempBucket = new gcp.storage.Bucket("ds", {
//   autoclass: {
//     enabled: true
//   },
//   logging: {

...
export interface ProviderSpec {
   ...
   *
   * @schema ProviderSpec#credentials
   */
  readonly credentials: ProviderSpecCredentials;

  /**
   * Provider is the cloud service provider, like `alibaba`
   *
   * @schema ProviderSpec#provider
   */
...
export function toJson_ProviderSpec(obj: ProviderSpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'credentials': toJson_ProviderSpecCredentials(obj.credentials),
 ...
 * Credentials required to authenticate to this provider.
 *
 * @schema ProviderSpecCredentials
 */
export interface ProviderSpecCredentials {
  /**
   * A SecretRef is a reference to a secret key that contains the credentials that must be used to connect to the provider.
   *
   * @schema ProviderSpecCredentials#secretRef
   */
  readonly secretRef?: ProviderSpecCredentialsSecretRef;

  /**
   * Source of the provider credentials.
   *
   * @schema ProviderSpecCredentials#source
   */
  readonly source: ProviderSpecCredentialsSource;

}

/**
 * Converts an object of type 'ProviderSpecCredentials' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ProviderSpecCredentials(obj: ProviderSpecCredentials | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'secretRef': toJson_ProviderSpecCredentialsSecretRef(obj.secretRef),
    'source': obj.source,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
...
/**
 * Converts an object of type 'ProviderSpecCredentialsSecretRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ProviderSpecCredentialsSecretRef(obj: ProviderSpecCredentialsSecretRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'key': obj.key,
    'name': obj.name,
 ...
 * Source of the provider credentials.
 *
 * @schema ProviderSpecCredentialsSource
 */
export enum ProviderSpecCredentialsSource {
  /** None */
  NONE = "None",
  /** Secret */
  SECRET = "Secret",
